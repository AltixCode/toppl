#!/usr/bin/env node
/**
 * Generates every brand asset for Toppl from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.08,"y":0.74,"w":0.84,"h":0.19,"r":0.07,"fill":"accentMid"},{"type":"rect","x":0.18,"y":0.5,"w":0.64,"h":0.19,"r":0.07,"fill":"accent"},{"type":"rect","x":0.29,"y":0.26,"w":0.42,"h":0.19,"r":0.07,"fill":"accentLight"},{"type":"rect","x":0.34,"y":0,"w":0.32,"h":0.13,"r":0.055,"fill":"accent"}];
 ...
 */
const MARK = [[0.12,0.12,1,0.12,0.12],[0.12,1,1,1,0.12],[0.12,0.45,1,0.45,0.12],[0.45,1,1,1,0.45],[1,1,1,1,1]];
...
console.log('Generating Toppl brand assets\n');
