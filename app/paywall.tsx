...
const BENEFITS = ["No ads, ever","Every tower skin and background","One free continue per run","Full run history and personal bests"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Toppl Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          A block swings overhead. Tap to drop. Stack it clean.
        </Text>
