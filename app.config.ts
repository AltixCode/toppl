...
/**
 * Store identity and native configuration for Toppl.
 *
...
const TRACKING_USAGE =
  'This lets us show you ads that are more relevant to you. Your data is never sold, and Toppl works exactly the same either way.';
...
const config: ExpoConfig = {
  ...
  assetBundlePatterns: ['**/*'],
  ios: {
    bundleIdentifier: 'com.altixcode.toppl',
    buildNumber: BUILD,
    supportsTablet: true,
